...
from knn import logistic_regression_knn_algorithm
...
if __name__ == "__main__":
    ...
    predictionsKnn, knnModel = logistic_regression_knn_algorithm(X_train_counts, X_test_counts, y_train, y_test)
